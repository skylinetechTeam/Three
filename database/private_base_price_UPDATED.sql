-- Tabela para configurar o preço base do táxi privado
-- ATUALIZADO COM PREÇOS DO CÓDIGO ATUAL (baseFare = 2500 Kz)
...
-- Inserir preços padrão (baseado no código atual: baseFare = 2500 Kz)
INSERT INTO private_base_price (price_type, base_price, description) VALUES
('normal', 2500.00, 'Preço base normal do privado'),
('peak_hours', 3250.00, 'Preço base nas horas de pico (7h-9h e 17h-19h) - +30%'),
('end_of_month', 2875.00, 'Preço base no fim do mês (últimos 5 dias) - +15%'),
('end_of_year', 3500.00, 'Preço base no fim do ano (dezembro) - +40%'),
('weekend', 2750.00, 'Preço base nos fins de semana - +10%'),
('night', 3000.00, 'Preço base no período noturno (22h-6h) - +20%')
